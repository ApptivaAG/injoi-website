...
lang: en
title: Digital menu
description: With injoi's digital menu, you have a flexible and powerful tool to showcase what your restaurant, bar or cafe has to offer in the best possible way.
...
Digital menus are a perfect replacement or even supplement for your classic menu. With injoi's digital menu you have the perfect tool to reach the next level as a host:in.
...
## Advantages of injoi as a digital menu

With injoi you have many advantages:

- injoi presents your menu as a website, which allows your offer to be found on Google. This way you will reach a large number of potential guests.
...
- With injoi, your guests can view the menu at any time to study your offer and place a new order.

- The injoi app offers simple and intuitive navigation, so your guests can easily find their way around your digital menu.

- One of the features in which injoi excels is the filters that dynamically adjust your offer and the preferences of your guests. Thus, it is possible to display only vegetarian dishes or hide dishes with certain allergy substances.

## injoi can do even more

The injoi app is an excellent digital menu. However, injoi can support your business much more widely. You decide which additional functions you want to enable for your guests.
...
injoi also allows you to take away and delivery orders.

Another feature of the injoi app is a guest call system via SMS.

<ButtonList>
  <ButtonLink href="/en/restaurant-order-app/">Order app</ButtonLink>
  <ButtonLink href="/en/functions/">Functions</ButtonLink>
  <ButtonLink href="/en/demo/">Try Demo</ButtonLink>
</ButtonList>

## Start for free

injoi as a digital dining app is completely free!
